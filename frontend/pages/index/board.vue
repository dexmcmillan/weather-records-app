<template>
    <div class="mx-auto">
        ...
        <div>
            ...
            <p><b>Last update</b>: {{ $date(new Date()) }}</p>
        </div>
        ...
        <div id="board" class="grid grid-cols-3">
            ...
            <div v-for="city in filtered_cities" :key="city.id" class="grid grid-cols-3 col-span-3 gap-3 mb-3">
                ...
                <digital-screen class="col-span-2 w-full" @click="flipped = !flipped" :string-to-display="!flipped ? `${city.CMANAME}, ${city.PRUID}` : `${city.type.toUpperCase()} TEMP RECORD`" :character-length=25 :city-data="city" />
